...
/**
* Ajax Class for Golidays.
*
* @package	Golidays
* @subpackage	Class
*/
class GolidaysClassAjax extends JObject
{
	/**
	...
	*/
	public static function responseHook($options = array(), $version)
	{
		...
		switch(strtoupper($options['renderExceptions']))
		{
			...
			case 'HTML':
				$return->transaction->htmlExceptions = GolidaysClassView::renderMessages('HTML');
				break;

			case 'TEXT':
				$return->transaction->rawExceptions = GolidaysClassView::renderMessages('TEXT');
				break;
			...
			default:
				...
				else
				{
					...
					$return->transaction->exceptions = GolidaysClassView::renderMessages(null);

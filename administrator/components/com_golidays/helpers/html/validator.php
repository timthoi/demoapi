...
*/
class GolidaysHelperHtmlValidator
{
	/**
	* Attach the form.
	*
	...
	*/
	public static function getJsonRule($field, $rule)
	{
		...
		if ($msgIncorrect = $field->getAttribute('msg-incorrect'))
			...
			$values["alertText"] = LI_PREFIX . JText::_('GOLIDAYS_FORMVALIDATOR_INCORRECT_VALUE');
	...
	*/
	public static function loadLanguageScript()
	{
		...
		$baseRules["required"] = array(
			"regex"	=> "none",
			"alertText" => LI_PREFIX . addslashes(JText::_("GOLIDAYS_FORMVALIDATOR_THIS_FIELD_IS_REQUIRED")),
			"alertTextCheckboxMultiple" => LI_PREFIX . addslashes(JText::_("GOLIDAYS_FORMVALIDATOR_PLEASE_SELECT_AN_OPTION")),
			"alertTextCheckboxe" => LI_PREFIX . addslashes(JText::_("GOLIDAYS_FORMVALIDATOR_THIS_CHECKBOX_IS_REQUIRED")),
			"alertTextDateRange" => LI_PREFIX . addslashes(JText::_("GOLIDAYS_FORMVALIDATOR_BOTH_DATE_RANGE_FIELDS_ARE_REQUIRED"))
		...
		$baseRules["numeric"] = array(
			"#regex"	=> '/^[\-\+]?\d+$/',
			"alertText" => LI_PREFIX . addslashes(JText::_("GOLIDAYS_FORMVALIDATOR_THIS_IS_NOT_A_VALID_INTEGER")),
		);
		...
		$baseRules["username"] = array(
			"#regex"	=> '/![\<|\>|\"|\'|\%|\;|\(|\)|\&]/i',
			"alertText" => LI_PREFIX . addslashes(JText::_("GOLIDAYS_FORMVALIDATOR_THIS_IS_NOT_A_VALID_USERNAME")),
		);


		$baseRules["password"] = array(
			"#regex"	=> '/^\S[\S ]{2,98}\S$/',
			"alertText" => LI_PREFIX . addslashes(JText::_("GOLIDAYS_FORMVALIDATOR_THIS_IS_NOT_A_VALID_PASSWORD")),
		);

		$baseRules["email"] = array(
			"#regex"	=> '/^[a-zA-Z0-9._-]+(\+[a-zA-Z0-9._-]+)*@([a-zA-Z0-9.-]+\.)+[a-zA-Z0-9.-]{2,4}$/',
			"alertText" => LI_PREFIX . addslashes(JText::_("GOLIDAYS_FORMVALIDATOR_THIS_IS_NOT_A_VALID_EMAIL")),
		);

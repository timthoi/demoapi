...
class JFormFieldModel extends JFormFieldGroupedList
{
	...
	*/
	protected function getGroups()
	{
		...
		$listGroups = GolidaysHelperForm::getElementGroups($this->element);
		...
		$items = GolidaysHelperForm::getItems($this);
		...
		foreach($items as $item)
		{
			...
			{
				$val = GolidaysHelper::parseValue($item, $labelKey);
				if ($val !== null)
	...
	*/
	protected function getOptions()
	{
		...
		if (!empty($items))
		foreach ($items as $item)
			$options[$item->$listKey] = GolidaysHelper::parseValue($item, $labelKey);
	...
	*/
	public function prepareModel(&$model)
	{
		...
		$groups = GolidaysHelperForm::getElementGroups($this->element);

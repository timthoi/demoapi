...
/**
* Script file of Golidays component
*
* @package	Golidays
* @subpackage	Installer
*/
class com_golidaysInstallerScript
{
	/**
	...
	*/
	...
	{
		$adapter->getParent()->setRedirectURL('index.php?option=com_golidays');
	...
	*/
	public function postflight($type, JAdapterInstance $adapter)
	{
		...
		$txtComponent = JText::_('COM_GOLIDAYS');

...
<script>
    jQuery( document ).ready(function($) {
        var data = {};
        var url_get_token =  "<?php echo JUri::root() . 'index.php?option=com_api&app=users&resource=login&format=raw'?>";
        ...
        $('body ').on('click', '.login-button', (function (e) {
            ...
            data["username"] = $("#modlgn-username").val();
            data["password"] = $("#modlgn-passwd").val();
            ...
            $.ajax({
                ...
                success: function (data, status, jqXHR) {
					if (data.data.code == 200) {
                        var msg1 = {
                            success: ["Your token: " + data.data.auth],
                        };
